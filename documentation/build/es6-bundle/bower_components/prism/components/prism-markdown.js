...
// ~strike~
pattern:createInline(/(~~?)(?:(?!~)<inner>)+?\2/.source,/* eat */ /* ignoreName */!1/* skipSlots */ /* skipSlots */),lookbehind:!0,greedy:!0,inside:{content:{pattern:/(^~~?)[\s\S]+(?=\1$)/,lookbehind:!0,inside:{}// see below
